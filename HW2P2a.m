...
Cell1 = 80;% Cell number across the annulus
Cell2 = 120;% Cell number across half size of center
...
AP(1:Cell2,Cell2+1) = AP(1:Cell2,Cell2+1) + AB2 - mu * Delta_x_1/ delta_x_c;
AP(1:Cell2,Cell) = AP(1:Cell2,Cell) + AB2;
AP(Cell2+1,1:Cell2) = AP(Cell2+1,1:Cell2) + AB2 - mu * Delta_x_1/ delta_x_c;
